            ...
            <div className="px-8 py-9 sm:px-10 sm:py-10">
              <div className="mb-6">
                ...
                <p className="text-[#A89584] mt-2 text-sm">
                  {isRegister
                    ? 'Join Imo Crafts to start shopping'
                    : 'Sign in to continue to the shop'}
                </p>
              </div>
              ...
              <div className="flex gap-2 p-1 bg-[#FAF6F1] rounded-xl mb-6 border border-[#E8DDD0]">
                <button
                  ...
                  className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-colors ${
                    !isRegister ? 'bg-white text-[#8B4513] shadow-sm' : 'text-[#A89584]'
                  }`}
                >
                  Login
                </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {isRegister && (
                  <div>
                    <label htmlFor="name" className="text-sm font-semibold text-[#5C4033] mb-2 block">
                      Full name
                    </label>
