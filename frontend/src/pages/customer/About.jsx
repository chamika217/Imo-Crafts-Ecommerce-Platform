...
import { ArrowRight, Heart, Star, Target, Package, Sparkles } from 'lucide-react';
    ...
    <div style={{ width: '100%', overflowX: 'hidden' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #FFF8F0 0%, #FFF3E0 100%)', padding: '72px 0' }}>
        <div className="page-container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '18px', color: '#6B7280', lineHeight: '1.7', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div className="page-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }}>
            {[
              ...
              { icon: Target, title: 'Personalized', desc: 'Custom designs tailored to your needs.' },
              { icon: Package, title: 'Safe Delivery', desc: 'Carefully packed and delivered island-wide.' },
              ...
              <div key={i} style={{ backgroundColor: 'white', borderRadius: '20px', padding: '32px', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #F3F4F6' }}>
                ...
                <h3 style={{ fontWeight: '700', color: '#1F2937', fontSize: '16px', marginBottom: '8px' }}>{title}</h3>
